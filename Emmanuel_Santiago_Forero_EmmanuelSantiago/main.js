...
class RecetaEspada{
    ...
    atacar(){
        ...
        if(durabilidad <= 0 && this.material != null){
            ...
            info = `La espada de '${this.material}' realizo un daño de ${this.info[0]}, la espada se rompio, inflinge efecto de ${this.info[3]} al enemigo`
        }else if(durabilidad > 0){
            durabilidad = durabilidad - (Math.floor(Math.random() * 5) + 1); 
            info = `La espada de '${this.material}' realizo un daño de ${this.info[0]}; la durabilidad es ${this.info[2]} / ${this.getDurabilidad}, inflinge efecto de ${this.info[3]} al enemigo`;
            this.setDurabilidad = durabilidad;
        }else{
...
const obj = new EspadaMadera("Madera", 10, "");
